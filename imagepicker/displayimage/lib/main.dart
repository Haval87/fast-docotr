...
class Spacecraft {
  ...
  final String specialist, imgUrl;
  ...
  factory Spacecraft.fromJson(Map<String, dynamic> jsonData) {
    return Spacecraft(
      ...
      imgUrl: "'http://trimaestro.tech/read.php/'"+jsonData['imgUrl'],
    );
  }
}
        ...
        title: new Card(
          ...
          child: new Container(
            ...
            child: Column(
              children: <Widget>[
                Padding(
                  child: Image.network(spacecraft.imgUrl),
                  padding: EdgeInsets.only(bottom: 8.0),
                ),
                Row(children: <Widget>[
                  Padding(
                      child: Text(
                        spacecraft.full_name,
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      Padding(
        ...
        child: Image.network('${widget.value.imgUrl}'),
        padding: EdgeInsets.all(12.0),
      ),
      Padding(
        child: new Text(
          'NAME : ${widget.value.full_name}',
          style: new TextStyle(fontWeight: FontWeight.bold),
      ...
      Padding(
        child: new Text(
          'PROPELLANT : ${widget.value.specialist}',
          style: new TextStyle(fontWeight: FontWeight.bold),
          textAlign: TextAlign.left,
        ),
        padding: EdgeInsets.all(20.0),
